...
from app.user import get_userid, is_admin, create_user
...
APP_PATH = '<app-path>'
CLIENT_ID = json.loads(open(APP_PATH + 'client_secrets.json', 'r')
                       .read())['web']['client_id']
APPLICATION_NAME = "SMARTY"
...
def gdisconnect():
    ...
    if result['status'] == '200':
        ...
        flash("Sie sind nun ausgeloggt!")
        return response
    else:
        response = make_response(
            json.dumps('Failed to revoke token for given user.', 400))
        #TODO: session cookie loeschen
        response.headers['Content-Type'] = 'application/json'
        return response
